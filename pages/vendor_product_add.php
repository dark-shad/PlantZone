        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <hr color="green">
                      <a href='vendor_panel.php' class='btn btn-warning btn-round'>Back to Index</a>
                <br>
                <div class="col-md-12">
...
if(isset($_POST['submit'])){
    ...
    $prod_serial = $prod_price*$prod_cost+$prod_price;   // function h
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group"> 
                            <select class="form-control" id="supplier" name="supplier" required> 
                              <?php
                              include('../config/dbconn.php');
                              $query=mysqli_query($dbconn,"SELECT supplier FROM vendor WHERE user_id='".$_SESSION['id']."'") or die(mysqli_error());
