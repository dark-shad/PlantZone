        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <a class="btn btn-primary btn-round" href="vendor_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Back to index</a>
                      <hr color="orange"> 
                <div class="col-md-12">
                <br>
                                            ...
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                               ...
                                               <?php }
                                                ...
                                                echo "<td><a href=\"vendor_product_details.php?prod_id=$res[prod_id]\">View</a></td>";
                                              echo "</tr>"; 
                                            }
                                          }?>
                                </table><br><br><br><br>
