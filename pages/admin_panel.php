            ...
            <div class="container">
               ...
               <div class="row">
                    <div class="col-md-6 ml-auto mr-auto">
                        ...
                        <div class="nav-align-center">
                            <ul class="nav nav-pills nav-pills-primary" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#vendorlog" role="tablist">
                                        <i class="now-ui-icons loader_refresh"></i>  
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="tab-content gallery">
                        ...
                        <div class="tab-pane" id="vendorlog" role="tabpanel">
                            <div class="col-md-12 ml-auto mr-auto">
                                <div class="row collections">
                                        <br>
                                        <div class="row">
                                            <div align="center">
                                                <h3>Vendor Logs Information</h3>
                                            </div>
                                        </div>
                                      <?php
                                      include('../config/dbconn.php');
                                      ...
                                      <br><br>
                                        <table id="" class="table table-bordered table-striped">
                                          <thead>
                                            ...
                                            <?php
                                                $query=mysqli_query($dbconn,"SELECT * FROM logs NATURAL JOIN vendor ORDER BY date DESC")or die(mysqli_error());
                                                while($row=mysqli_fetch_array($query)){ 
                                            ?>
                                          <tr>
                                            <td><?php echo $row['firstname']." ".$row['lastname']." ".$row['action']." last ".$row['date'];?></td>
