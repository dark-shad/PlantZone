...
{   
    ...
    if(empty($firstname) || empty($lastname) || empty($supplier)|| empty($email) || empty($username) || empty($password)) {    
        ...
        //updating the table
        $query = "INSERT INTO vendor (firstname, lastname, supplier, email, username, password) 
                VALUES ('$firstname','$lastname','$supplier','$email','$username','$pass1')";
                    ...
                    <form class="form" method="post" action="">
                        ...
                        <div class="content">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" name="supplier" class="form-control" placeholder="supplying as" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
