        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="./assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages/chatbot_index.php" onclick="scrollToDownload()">
                            <i class="now-ui-icons shopping_cart-simple"></i>
                            <p>Talk to us</p>
                        </a>
                    </li>
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="typography-line">
                            <p>Gardening is about enjoying the smell of things growing in the soil, getting dirty without feeling guilty, and generally taking the time to soak up a little peace and serenity"
                            “ </p>
                        </div>
                        <br>
